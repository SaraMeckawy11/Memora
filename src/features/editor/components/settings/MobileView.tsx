...
interface MobileViewProps {
  ...
  mobileTabs: Array<{ id: string; label: string; icon: React.ReactNode; content: () => React.ReactNode }>;
}

export default function MobileView({ step, activeMobileTab, setActiveMobileTab, mobileTabs }: MobileViewProps) {
    ...
    <div className="mobile-interface">
      <div ref={drawerRef} className={`mobile-drawer ${activeMobileTab ? 'open' : ''}`}>
        <div className="mobile-drawer-header">
          ...
          <button className="close-drawer" onClick={() => setActiveMobileTab(null)}>
