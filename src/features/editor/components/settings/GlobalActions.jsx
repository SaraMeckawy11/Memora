...
import { LAYOUTS } from './LayoutSection'
  ...
  return (
    <div className="editor-card global-actions-card">
      <div className="action-row">
        ...
        <label className={`switch-modern ${store.autoSave ? 'checked' : 'unchecked'}`}>
          <input
            type="checkbox"
            checked={store.autoSave}
            onChange={(e) => store.updateGlobalSettings({ autoSave: e.target.checked })}
          />
      ...
      <div className="action-row">
        ...
        <button
          type="button"
          onClick={() => {/* Zustand persists automatically */}}
