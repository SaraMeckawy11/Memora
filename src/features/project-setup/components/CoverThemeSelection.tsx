...
export default function CoverThemeSelection() {
  const store = useProjectStore()
  const coverTheme = store.coverTheme
  const coverImage = store.coverImage
  
  const setCoverTheme = (theme: string) => store.setProjectDetails({ coverTheme: theme })
  const setCoverImage = (img: ProjectImage | null) => store.setProjectDetails({ coverImage: img })
